...
too simple at this point, just add your name and the current date at the top of each 
program file. Then write one sentence describing what the program does.*/ 

// program: 1
// author: {soniya dawood}
// date: {02/20/2024}

// task: printing my favorite color
let favoriteColor: string = "blue";

//reveling my favorite color
...
// task: Find a quote from a famous person you admire.
